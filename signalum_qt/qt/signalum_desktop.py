...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.wifiShowInfo = QtWidgets.QCheckBox(self.optionsTab)
        self.wifiShowInfo.setObjectName("wifiShowInfo")
        self.formLayout.setWidget(7, QtWidgets.QFormLayout.LabelRole, self.wifiShowInfo)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.FieldRole, self.wifiRefreshRate)
        self.verticalLayout_19 = QtWidgets.QVBoxLayout()
        self.verticalLayout_19.setObjectName("verticalLayout_19")
        self.formLayout.setLayout(11, QtWidgets.QFormLayout.LabelRole, self.verticalLayout_19)
        self.label_9 = QtWidgets.QLabel(self.optionsTab)
        self.label_9.setObjectName("label_9")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.label_9)
        self.wifiSwitch = QtWidgets.QCheckBox(self.optionsTab)
        self.wifiSwitch.setObjectName("wifiSwitch")
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.wifiSwitch)
        self.checkBox_3 = QtWidgets.QCheckBox(self.optionsTab)
        self.checkBox_3.setObjectName("checkBox_3")
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.checkBox_3)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.wifiShowInfo.setText(_translate("MainWindow", "Show extra  information"))
